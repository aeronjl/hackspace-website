...
<div class="font-serif font-light flex flex-col mx-auto items-center justify-center h-screen">
    ...
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSeAlNNQLhd5X4_SK5PU__lWW3ugq5Cfy57equ8MCOBqioc8SA/viewform" class="text-large underline">Register your interest</a>
</div>
</div>